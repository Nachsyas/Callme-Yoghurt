...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F0EB] text-[#1E3932] flex font-sans antialiased">
      {/* FIXED LEFT SIDEBAR: Deep Forest Green #1E3932 */}
      <aside className="w-64 bg-[#1E3932] text-white flex flex-col justify-between flex-shrink-0 border-r border-[#172C27] sticky top-0 h-screen">
        <div>
          {/* Logo & Brand Block */}
          <div className="p-5 border-b border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-[#00754A] flex items-center justify-center text-white font-black text-sm tracking-wider shadow-sm">
                CY
              </div>
              <div>
                ...
                <span className="text-[10px] uppercase tracking-widest text-[#98D8B6] font-semibold block">
                  Operations Console
                </span>
              </div>
            </div>
            <span className="text-[10px] px-2 py-0.5 rounded bg-white/10 text-white/80 border border-white/15 font-mono">
              v1.5
            </span>
          </div>

          {/* Sidebar Navigation: 8 Core Menus */}
          <nav className="p-3 space-y-1 text-xs font-medium">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#98D8B6]/70 px-3 pt-2 pb-1.5 block">
              Menu Navigasi
            </span>
            ...
            <Link
              href="/admin"
              className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-[#00754A] text-white font-semibold shadow-sm transition-colors"
            >
              <div className="flex items-center gap-3">
            ...
            <a
              href="#inventory"
              className="flex items-center justify-between px-3 py-2.5 rounded-xl text-white/80 hover:text-white hover:bg-white/10 transition-colors"
            >
              <div className="flex items-center gap-3">
                <Boxes size={16} />
                <span>Inventory</span>
              </div>
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#00754A] text-white font-mono">
                520
              </span>
            </a>
            ...
            >
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-500 text-white font-mono font-bold">
                4 Pending
              </span>
            </a>
            ...
            >
              ...
              <span className="text-[10px] text-[#98D8B6] font-mono font-bold">2.4°C</span>
            </a>
        ...
        <div className="p-4 border-t border-white/10 bg-[#172C27]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        {/* Top Header Bar */}
        <header className="bg-white border-b border-[#E5E2DA] px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sticky top-0 z-30 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-[#1E3932] tracking-tight">
              Dashboard
            </h1>
            <p className="text-xs text-[#5C6F68] mt-0.5 font-medium">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#E8F5E9] border border-[#C8E6C9] text-xs font-semibold text-[#1E3932]">
            ...
            <span className="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-semibold bg-[#E8F5E9] text-[#1E3932] border border-[#C8E6C9]">
              Authenticated Session Active
            </span>

            {/* User Profile Pill */}
            <div className="hidden md:flex items-center gap-2 pl-2 border-l border-[#E5E2DA] text-xs font-medium text-[#5C6F68]">
        ...
        <main className="p-6 space-y-6 max-w-7xl">
          {/* SECTION 1: 4 DISCIPLINED KPI SUMMARY CARDS (Max 4 cards) */}
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Card 1: Total Orders */}
            <div className="bg-white p-5 rounded-xl border border-[#E5E2DA] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
              ...
              <p className="mt-3 text-2xl font-black text-[#1E3932] tracking-tight">
                28 Pesanan
              </p>
            ...
            <div className="bg-white p-5 rounded-xl border border-[#E5E2DA] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
              ...
              <p className="mt-3 text-2xl font-black text-[#00754A] tracking-tight">
                2°C – 4°C Nominal
              </p>
          ...
          {/* Prioritizes concrete decisions for owner: pending orders, expiry rotation, cold chain safety, action items */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6">
              {/* Table 1: Recent Orders Data Table */}
              ...
              {/* Table 2: Inventory & FEFO Priority View */}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div id="cold-chain" className="bg-white p-5 rounded-xl border border-[#E5E2DA] shadow-[0_1px_3px_rgba(0,0,0,0.04)] space-y-4">
              ...
              {/* Owner Daily Operational Checklist */}
